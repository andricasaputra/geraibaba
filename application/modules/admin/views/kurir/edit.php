...
<div class="row">
    <div class="col-4 offset-4 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <br>
          <form class="forms-sample" action="<?php echo base_url('admin/kurir/update/'. $kurir['id']); ?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
              <input type="hidden" class="form-control text-uppercase" name="id" value="<?php echo $kurir['id'] ?>">
              <label for="kurir">Nama Kurir</label>
              <input type="text" class="form-control text-uppercase" id="kurir" name="kurir" value="<?php echo $kurir['nama'] ?>" autofocus>
            </div>
