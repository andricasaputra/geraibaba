...
<!-- chat WhatsApp -->
  <a href="https://wa.me/6285269496989" target="_blank"><img src="<?php echo base_url();?>assets/img/wa_2.png" width="50px" style="position: fixed;bottom: 25px; right: 20px;z-index: 5;" class="animated swing" id="iconapk">
  </a>
  <!--Main layout-->
  <main>
    <!-- Categori -->
      ...
      <nav class="navbar navbar-expand-lg navbar-dark mdb-color lighten-3 mt-3 mb-5">
        ...
        <div class="collapse navbar-collapse" id="basicExampleNav">
          ...
          <ul class="navbar-nav mr-auto">
            <li class="nav-item">
              <a class="nav-link" style="font-weight: 500" href="<?php echo base_url() ?>">All Categories
              </a>
            </li>

            <?php foreach($kategori as $k): ?>
            <li class="nav-item">
              <a class="nav-link" style="font-weight: 500" href="<?php echo base_url('home/product/kategori/'. $k['kategori']) ?>"><?php echo ucwords($k['kategori']) ?>
              </a>
            </li>
            <?php endforeach; ?>
